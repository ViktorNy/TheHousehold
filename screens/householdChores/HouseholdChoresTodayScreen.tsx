...
export default function HouseholdChoresTodayScreen({ navigation, route }: RootStackScreenProps<'HouseholdChores'>) {
    ...
    if (household) {
        return (
            <View style={styles.root}>
                ...
                <RenderChores label={'Today'} currentHousehold={household} members={memberList} editChore={toggleEdit} />
                {!toggleEdit && (
